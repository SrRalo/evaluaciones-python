...
class register13(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(400, 416)
        ...
        # Campos de entrada (Nota, ID Docente, ID Evaluación Asignada)
        self.lineEdit_nota = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_nota.setGeometry(QtCore.QRect(50, 110, 301, 22))
        self.lineEdit_nota.setObjectName("lineEdit_nota")
        
        self.label_nota = QtWidgets.QLabel(Dialog)
        self.label_nota.setGeometry(QtCore.QRect(50, 90, 141, 16))
        self.label_nota.setObjectName("label_nota")
        
        self.lineEdit_docente = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_docente.setGeometry(QtCore.QRect(50, 180, 301, 22))
        self.lineEdit_docente.setObjectName("lineEdit_docente")
        
        self.label_docente = QtWidgets.QLabel(Dialog)
        self.label_docente.setGeometry(QtCore.QRect(50, 160, 141, 16))
        self.label_docente.setObjectName("label_docente")
        
        self.lineEdit_evaluacion = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_evaluacion.setGeometry(QtCore.QRect(50, 250, 301, 22))
        self.lineEdit_evaluacion.setObjectName("lineEdit_evaluacion")
        
        self.label_evaluacion = QtWidgets.QLabel(Dialog)
        self.label_evaluacion.setGeometry(QtCore.QRect(50, 230, 141, 16))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Registro Detalle Evaluación Docente"))
        self.label.setText(_translate("Dialog", "Registro Detalle Evaluación Docente"))
        self.label_nota.setText(_translate("Dialog", "Nota de Evaluación:"))
        self.label_docente.setText(_translate("Dialog", "ID Docente:"))
        self.label_evaluacion.setText(_translate("Dialog", "ID Evaluación Asignada:"))

    def save_data(self):
        # Capturar los datos del formulario
        nota = self.lineEdit_nota.text()  # Obtener la Nota
        id_docente = self.lineEdit_docente.text()  # Obtener el ID Docente
        ...
        data = {
            'nota_evaDocente': nota,  # Nota de la evaluación docente
            'id_docente': id_docente,  # ID del docente
        ...
        table_name = "evaluacionesTI.Detalle_EvaDocente"  # Nombre de la tabla en la base de datos
